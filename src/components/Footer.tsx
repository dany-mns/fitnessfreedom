...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/chris.ifbb',
      icon: (
    ...
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/share/1Ci5g5chbU/?mibextid=wwXIfr',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'TikTok',
      href: 'https://www.tiktok.com/@chris.ifbb',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="bg-[#0a0a14] text-white pt-16 pb-8 px-4">
