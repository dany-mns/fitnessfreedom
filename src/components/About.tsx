        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          <div className="flex-1 w-full max-w-md lg:max-w-none">
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-r from-[#dabc68] to-[#e8cc7a] rounded-2xl blur-2xl opacity-20"></div>
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="mt-8 grid grid-cols-3 gap-4 sm:gap-8">
              <div className="text-center">
                <div className="text-3xl sm:text-4xl font-bold text-[#dabc68]">500+</div>
                <div className="text-white/60 text-sm sm:text-base">{t.about.stat1}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl sm:text-4xl font-bold text-[#dabc68]">10+</div>
                <div className="text-white/60 text-sm sm:text-base">{t.about.stat2}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl sm:text-4xl font-bold text-[#dabc68]">98%</div>
